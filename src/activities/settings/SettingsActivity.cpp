...
void SettingsActivity::rebuildSettingsLists() {
  ...
  systemSettings.push_back(SettingInfo::Action(StrId::STR_PAGER, SettingAction::Pager));
  ...
  if (setting.type == SettingType::TOGGLE && setting.valuePtr != nullptr) {
    ...
    switch (setting.action) {
      ...
      case SettingAction::SdFirmwareUpdate:
        ...
        break;
      case SettingAction::Pager:
        startActivityForResult(std::make_unique<PagerSettingsActivity>(renderer, mappedInput), resultHandler);
        break;
